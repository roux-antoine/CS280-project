...
blue_players_video = []   #list of all the positions of all blue players in all images
white_players_video = []  #list of all the positions of all white players in all images
...
for image_path in TEST_IMAGE_PATHS:
  ...
  for box in boxes_array:
    ...
    if box[2]-box[0] <= 0 or box[3]-box[1] <= 0:
      ...
      if detect == 'blue':
          blue_players_video.append([(box[1]+box[3])/2, (box[0]+box[2])/2])
      elif detect == 'white':
          white_players_video.append([(box[1]+box[3])/2, (box[0]+box[2])/2])
      else:
          pass
...
for white_player_video in white_players_video:
        ...
        white_players_map.append([int(player_pos[0]), int(player_pos[1])])

np.savetxt('blue_pos.csv', np.asarray(blue_players_map), delimiter=',')
np.savetxt('white_pos.csv', np.asarray(white_players_map), delimiter=',')
